...
import { MarketingAuthorizationType, projectTaskCode, projectTaskNames, submissionStatus, taskStatus } from "../../../constants/general";
import { usePatchCancelProjectTask } from "../../../hooks/useNewRegSubmission";
import { usePatchProjectTask } from "../../../hooks/useNewRegTask";
import { submissionSchemas } from "../schemas/submission";
import ApprovableLetterForm from "./ApprovableLetterForm";
import LetterCard, { ViewDocumentButton } from "./LetterCard";
...
const ProjectTaskDetails = ({ submission, task, onRefresh }) => {
  ...
  const getMAFieldValue = (field = LATEST_MA, fallback = "") =>
    ONGOING_MA?.[field] || LATEST_MA?.[field] || submission?.[field] || fallback;
        ...
        try {
          ...
          const payload = {
            ...
            DATA: {
              ...
              ...additionalObject,
              ...additionalPayload,
              MARKETING_AUTHORIZATION_TYPE: MarketingAuthorizationType.NEW,
            },
          };
