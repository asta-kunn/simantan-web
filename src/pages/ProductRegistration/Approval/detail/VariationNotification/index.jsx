...
// Custom components
import LetterCard from "@/pages/ProductRegistration/RegistrationVariationNotification/components/LetterCard";
import ProjectTaskDetails from "@/pages/ProductRegistration/RegistrationVariationNotification/pages/Submission/Detail/components/ProjectTaskDetails";
import RegistrationVersion from "@/pages/ProductRegistration/RegistrationVariationNotification/pages/Submission/Detail/components/RegistrationVersion";
import SubmissionDetailHeader from "@/pages/ProductRegistration/RegistrationVariationNotification/pages/Submission/Detail/components/SubmissionDetailHeader/index";
...
import { useApprovalDetail, usePatchSubmissionReview } from "@/pages/ProductRegistration/Approval/detail/VariationNotification/hooks/useApproval";

const VariationNotificationApprovalDetail = () => {
                ...
                content: (
                  <Fragment>
                    <Accordion
                      ...
                      icon={<Layers className="size-4 text-primary-normal" />}
                      className="mb-4"
                    >
                      <RegistrationVersion
                        marketingAuthorizations={
                          submission?.REGISTRATION_VERSIONS
                        }
                      />
                    </Accordion>
                    <Accordion
                      ...
                      title="Project Task"
                      icon={
                        <ListChecks className="size-4 text-primary-normal" />
                      }
                    >
                      <div className="p-4">
...
export default VariationNotificationApprovalDetail;
