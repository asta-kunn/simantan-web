    ...
    () => [
      {
        ...
        onClick: (row) => {
          navigate(`/product-registration/approval/detail`, {
            state: { submissionId: row.SUBMISSION_ID, registrationType: "New", mainTab: "history", secondaryTab: activeTab },
          });
        },
      },
    ],
    ...
    () => [
      {
        ...
        onClick: (row) => {
          navigate(`/product-registration/approval/detail`, {
            state: { submissionId: row.SUBMISSION_ID, registrationType: "VariationNotification", mainTab: "history", secondaryTab: activeTab },
          });
        },
      },
    ],
