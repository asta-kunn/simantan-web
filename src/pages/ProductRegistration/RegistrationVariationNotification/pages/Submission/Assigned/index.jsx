...
const RegistrationSubmissionAssigned = ({ data }) => {
  ...
  return (
    <div className="flex flex-col gap-2">
      <Info
        ...
        label="Registration Submission Assigned"
        labelClassName="font-bold text-black text-xl"
        value="List of registration submission from PMO that you need to process"
...
export default RegistrationSubmissionAssigned;
