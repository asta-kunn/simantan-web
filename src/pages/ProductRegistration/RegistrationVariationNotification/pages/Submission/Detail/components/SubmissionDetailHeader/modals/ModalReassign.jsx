...
import ConfirmationReassign from "../confirmations/ConfirmationReassign";

/** Hooks */
import { useGetUsers } from "@/hooks/master-data/useMasterData";
import { usePatchReassignSubmission } from "../../../../../../hooks/useSubmission";
...
const ModalReassign = ({ submission, refetch }) => {
  ...
  return (
    <Fragment>
      <div className="flex items-center px-4 py-1 border-b bg-gray-200 gap-2">
